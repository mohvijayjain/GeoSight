...
function TeamSection() {
  ...
  const achievements = [
    { icon: '🏆', title: 'Best Project Award', description: 'University Innovation Challenge 2024' },
    { icon: '📊', title: '91% Accuracy', description: 'State-of-the-art performance' },
    { icon: '🚀', title: 'Production Ready', description: 'Deployed and scalable' },
    { icon: '📝', title: 'Research Paper', description: 'Submitted to IEEE Conference' }
  ];
